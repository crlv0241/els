<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['addItem'])){
        ...
        $edition_n     = $_POST['edition-number'] ?? "none";
        ...
        $columns = "category,	isbn,	title,	publisher,	date,	genre,	edition,	editionNum,	quantity,	author,	description,	img";
        ...
        if( $stm -> rowCount() > 0){
            ...
            $stm -> bindValue(10, $author);
            $stm -> bindValue(11, $description);
            $stm -> bindValue(12, $img);
